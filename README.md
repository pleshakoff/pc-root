...
##### Взаимодействие с другими сервисами     
 ...
 учетной записи сервиса  [Security](#Security). Если вызов неудачен, то создание откатывается.  
...
Потенциально может аггрегировать новости из других источников и показывать их родителям. 
